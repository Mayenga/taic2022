      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          <div class="col-lg-6">
            ...
            <p>The Tanzania Annual ICT Conference (TAIC) is one of the largest international gathering of
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div style="text-align:center" class="speaker" data-aos="fade-up" data-aos-delay="300">
              <img src="{{ asset('siteimg/speakers/person.png') }}" alt="Speaker 3" class="img-fluid">
              <div class="details">
                <h3><a href="speaker-details.html">Full Name</a></h3>
                <p>Occupation</p>
                <p>To be Comfirmed</p>
                <div class="social">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="100">
              <img src="{{ asset('siteimg/speakers/person.png') }}" alt="Speaker 1" class="img-fluid">
              <div class="details">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="speaker" data-aos="fade-up" data-aos-delay="200">
              <img src="{{ asset('siteimg/speakers/person.png') }}" alt="Speaker 2" class="img-fluid">
              <div class="details">
        ...
        <div class="tab-content row justify-content-center" data-aos="fade-up" data-aos-delay="200">
          ...
          <div role="tabpanel" class="col-lg-9 tab-pane fade show active" id="day-1">
            ...
            <!-- <div class="row schedule-item">
              ...
              <div class="col-md-10">
                <div class="speaker">
                  <img src="{{ asset('siteimg/speakers/1.jpg') }}" alt="Brenden Legros">
                </div>
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                <div class="speaker">
                  <img src="{{ asset('siteimg/speakers/2.jpg') }}" alt="Hubert Hirthe">
                </div>
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                <div class="speaker">
                  <img src="{{ asset('siteimg/speakers/3.jpg') }}" alt="Cole Emmerich">
                </div>
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                <div class="speaker">
                  <img src="{{ asset('siteimg/speakers/4.jpg') }}" alt="Jack Christiansen">
                </div>
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                <div class="speaker">
                  <img src="{{ asset('siteimg/speakers/5.jpg') }}" alt="Alejandrin Littel">
                </div>
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                <div class="speaker">
                  <img src="{{ asset('siteimg/speakers/6.jpg') }}" alt="Willow Trantow">
                </div>
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="{{ asset('siteimg/venue-gallery/1.jpg') }}" class="glightbox" data-gall="venue-gallery">
                <img src="{{ asset('siteimg/venue-gallery/1.jpg') }}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="{{ asset('siteimg/venue-gallery/2.jpg') }}" class="glightbox" data-gall="venue-gallery">
                <img src="{{ asset('siteimg/venue-gallery/2.jpg') }}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="{{ asset('siteimg/venue-gallery/3.jpg') }}" class="glightbox" data-gall="venue-gallery">
                <img src="{{ asset('siteimg/venue-gallery/3.jpg') }}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="{{ asset('siteimg/venue-gallery/4.jpg') }}" class="glightbox" data-gall="venue-gallery">
                <img src="{{ asset('siteimg/venue-gallery/4.jpg') }}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="{{ asset('siteimg/venue-gallery/5.jpg') }}" class="glightbox" data-gall="venue-gallery">
                <img src="{{ asset('siteimg/venue-gallery/5.jpg') }}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="{{ asset('siteimg/venue-gallery/6.jpg') }}" class="glightbox" data-gall="venue-gallery">
                <img src="{{ asset('siteimg/venue-gallery/6.jpg') }}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="{{ asset('siteimg/venue-gallery/7.jpg') }}" class="glightbox" data-gall="venue-gallery">
                <img src="{{ asset('siteimg/venue-gallery/7.jpg') }}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="venue-gallery">
              <a href="{{ asset('siteimg/venue-gallery/8.jpg') }}" class="glightbox" data-gall="venue-gallery">
                <img src="{{ asset('siteimg/venue-gallery/8.jpg') }}" alt="" class="img-fluid">
              </a>
            </div>
          </div>
    ...
    <!-- <section id="gallery">
      ...
      <div class="gallery-slider swiper">
        <div class="swiper-wrapper align-items-center">
          <div class="swiper-slide"><a href="{{ asset('siteimg/gallery/1.jpg') }}" class="gallery-lightbox"><img src="{{ asset('siteimg/gallery/1.jpg') }}" class="img-fluid" alt=""></a></div>
          <div class="swiper-slide"><a href="{{ asset('siteimg/gallery/2.jpg') }}" class="gallery-lightbox"><img src="{{ asset('siteimg/gallery/2.jpg') }}" class="img-fluid" alt=""></a></div>
          <div class="swiper-slide"><a href="{{ asset('siteimg/gallery/3.jpg') }}" class="gallery-lightbox"><img src="{{ asset('siteimg/gallery/3.jpg') }}" class="img-fluid" alt=""></a></div>
          <div class="swiper-slide"><a href="{{ asset('siteimg/gallery/4.jpg') }}" class="gallery-lightbox"><img src="{{ asset('siteimg/gallery/4.jpg') }}" class="img-fluid" alt=""></a></div>
          <div class="swiper-slide"><a href="{{ asset('siteimg/gallery/5.jpg') }}" class="gallery-lightbox"><img src="{{ asset('siteimg/gallery/5.jpg') }}" class="img-fluid" alt=""></a></div>
          <div class="swiper-slide"><a href="{{ asset('siteimg/gallery/6.jpg') }}" class="gallery-lightbox"><img src="{{ asset('siteimg/gallery/6.jpg') }}" class="img-fluid" alt=""></a></div>
          <div class="swiper-slide"><a href="{{ asset('siteimg/gallery/7.jpg') }}" class="gallery-lightbox"><img src="{{ asset('siteimg/gallery/7.jpg') }}" class="img-fluid" alt=""></a></div>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-address">
              ...
              <h3>Address</h3>
              <address>14 Jamhuri Street, Dar Es Salaam, Tanzania</address>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-phone">
              ...
              <h3>Phone Number</h3>
              <p><a href="tel:+155895548855">+255 738 171 742</a></p>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-email">
              ...
              <h3>Email</h3>
              <p><a href="mailto:info@example.com">info@ictc.go.tz</a></p>
            </div>
          </div>
